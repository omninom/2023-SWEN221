...
public class Game {
  ...
  /**This operation moves down until it is not possible
  ...
  public void landing() {
    while (true){                 //infinite loop
      int y= active.centerY();  //current y coordinate
      moveDown();
      if (active.centerY() == y) { break; }   //if the y coordinate did not change, stop
    }
  }
